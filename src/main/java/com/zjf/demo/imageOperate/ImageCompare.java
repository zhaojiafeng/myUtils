...
public class ImageCompare {
    ...
    public ImageCompare(byte[] hashValue) {
    ...
    public ImageCompare(String hashValue) {
        this(toBytes(hashValue));
    }

    public ImageCompare(BufferedImage src) {
        this(hashValue(src));
    }
     ...
     * @return
     */
    public static ImageCompare createFromCompact(byte[] compactValue) {
        return new ImageCompare(uncompact(compactValue));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ImageCompare) {
            return Arrays.equals(this.binaryzationMatrix, ((ImageCompare) obj).binaryzationMatrix);
        } else
    ...
    public float compare(String hashValue) {
        return compare(new ImageCompare(hashValue));
    }
    ...
    public float compare(BufferedImage image2) {
        return compare(new ImageCompare(image2));
    }
     ...
     */
    public float compare(ImageCompare src) {
    ...
    public static float compare(BufferedImage image1, BufferedImage image2) {
        return new ImageCompare(image1).compare(new ImageCompare(image2));
    }
